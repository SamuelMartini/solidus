...
RSpec.describe Spree::EmailObserver do
  ...
  describe '#update' do
    ...
    context ':shipped' do
      ...
      context 'when the mailer is not suppressed' do
        subject { observer.update(:shipped, carton, false) }
      ...
      context 'when the mailer is suppressed' do
        subject { observer.update(:shipped, carton, true) }

        it 'does not send an email' do
          expect(mailer).not_to receive(:shipped_email)
        end
      end
    end
  end
